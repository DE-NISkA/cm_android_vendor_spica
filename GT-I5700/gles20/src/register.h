...
//-- HI2.0
#define FGGB_EXESTATE           (FIMG_BASE+0x00000100)
#define FGGB_NEXTSTEP                   (FIMG_BASE+0x00000104)
#endif
...
#define FGHI_FIFO_EMPTY_SPACE           (FIMG_BASE+0x8000)
    ...
    #define FGHI_FIFO_ENTRY                     (FIMG_BASE+0x8004)
#elif TARGET_PLATFORM == FPGA_BOARD
        ...
        #else
        #define FGHI_FIFO_ENTRY                 (FIMG_BASE+0xA000)
        #endif
#endif
#endif
...
#if 0 //TARGET_FIMG_VERSION == _FIMG3DSE_VER_1_2 
...
#if TARGET_FIMG_VERSION == _FIMG3DSE_VER_2_0
//-- HI2.0
#define FGHI_INSTADDR                   (FIMG_BASE+0x9000)
#define FGHI_INSTCOUNT                  (FIMG_BASE+0x9004)
#define FGHI_INSTADDRNEXT               (FIMG_BASE+0x9008)
#define FGHI_INSTCOUNTLEFT              (FIMG_BASE+0x900C)
#define FGHI_INST0                              (FIMG_BASE+0x9010)
#define FGHI_INST1                              (FIMG_BASE+0x9014)
#define FGHI_INST2                              (FIMG_BASE+0x9018)
#define FGHI_INST3                              (FIMG_BASE+0x901C)
#define FGHI_EXECTRL                    (FIMG_BASE+0x9100)
#define FGHI_VBSIZE                             (FIMG_BASE+0x9104)
#define FGHI_PREVCCLR                   (FIMG_BASE+0x9108)
#define FGHI_POSTVCCLR                          (FIMG_BASE+0x910C)
#endif
...
/* R/W Vertex texture náïs control */
 ...
 *      PRE-DEPTH TEST
 *****************************************************************************/
#define FGPDT_DEPTHBUF_BASE             (FIMG_BASE+0x78000) /* R/W      Stencil/depth buffer base address */
#define FGPDT_DEPTHBUF_WIDTH    (FIMG_BASE+0x78004)     /* R/W  Depth buffer width */
#define FGPDT_FFACE_STENCIL     (FIMG_BASE+0x78008)     /* R/W  Front face stencil test */
#define FGPDT_FFSTENCIL_WMASK   (FIMG_BASE+0x7800C)     /* R/W  Front face stencil buf write mask */
#define FGPDT_BFACE_STENCIL     (FIMG_BASE+0x78010)     /* R/W  Back face stencil test ctrl */
#define FGPDT_BFSTENCIL_WMASK   (FIMG_BASE+0x78014)     /* R/W  Back face stencil buf write mask  */
#define FGPDT_DEPTH_TEST                (FIMG_BASE+0x78018)     /* R/W  Depth test ctrl  */

#define FGPDT_SHADER_THRESOLD   10                  /* experimental numerical value for PDT performance */
#endif

#if TARGET_PLATFORM == WIN32_VIP
/*****************************************************************************
        DAA(MEMORY ACCESS ABITER) REGISTER
 *****************************************************************************/
    #define FIMG_CLEARBUF_START                 0x80000 /* W */
    #define FIMG_CLEARBUF_ADDR                  0x80004 /* W */
    #define FIMG_CLEARBUF_SIZE                  0x80008 /* W */
    #define FIMG_CLEARBUF_FILLDATA              0x8000C /* W */
    #define FIMG_CLEARBUF_CTRL                  0x80010 /* W */
    #define FIMG_CLEARBUF_END                   0x80010 /* W */
#endif
