...
#define GL_COLOR_BUFFER_WITH_IMAGE_BIT 0x00040000 //cglee
...
GL_API void GL_APIENTRY *glMapTexture(GLenum target, GLint level, GLenum access);
GL_API GLboolean GL_APIENTRY glUnmapTexture(GLenum target);
