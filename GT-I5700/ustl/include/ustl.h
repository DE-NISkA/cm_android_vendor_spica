...
/// vectors, allowing acropriate constructors and destructors to be called on
...
/// containers are then implemented as template wracers for memblock to
...
/// "disacear", due to the requirement for calling placement constructors
...
///     are much more readable (through an acropriate formatting tool equiced
...
/// diametrically ocosed to object oriented programming, where each object
...
/// The best acroach is to compromise and have raw data classes that will
...
///             /ingroup MutatingAlgorithms
///             Algorithms for swacing elements.
//
...
/// no doubt hacy that C++ can now be made to look just like their precious lisp.
