...
public:
    ...
    static const size_type size_Terminator = sizeof(c_Terminator);      ///< Most systems terminate strings with '\\'
...
public:
  ...
  inline const_reverse_iterator rend (void) const       { return (const_reverse_iterator (begin())); }
    ...
    inline iterator             erase (void)    { return (erase (begin(), size())); }   //liyue 090318
