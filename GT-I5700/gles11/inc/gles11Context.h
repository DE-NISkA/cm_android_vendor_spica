...
//GLboolean GLES11Initdriver(int g3dfd);
...
GLboolean BufferFree(BufferHandle handle);
...
GLboolean GLES11SetDrawSurface(GLES11SurfaceData *surface);
GLboolean GLES11SetReadSurface(GLES11SurfaceData *surface);
